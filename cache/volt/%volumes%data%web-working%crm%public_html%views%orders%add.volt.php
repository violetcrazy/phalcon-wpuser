        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= $this->callMacro('formGroupInputVertical', ['feeplus[value]', ['label' => 'Giá trị <sup>(*)</sup>', 'value' => '', 'id' => 'feeplus_value', 'type' => 'number']]) ?>
                    <?= $this->callMacro('formGroupInputVertical', ['feeplus[note]', ['label' => 'Tên chi phí <sup>(*)</sup>', 'value' => '', 'id' => 'feeplus_note', 'type' => 'textarea']]) ?>
                </div>
